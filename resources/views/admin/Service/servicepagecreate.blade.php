            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Service Detail Page</h1>
                ...
                <div class="col-lg-12 pt-5">
                    <form action="../servicepageinsert" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <textarea class="summernote" name="content" rows="10"></textarea>
                        </div>
                        {{-- <div class="form-group">
