            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Industry Detail Page Third and Fourth Section</h1>
                ...
                <div class="col-lg-12 pt-5">
                    ...
                    <form action="{{url('/admin/industrypageupdate')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
