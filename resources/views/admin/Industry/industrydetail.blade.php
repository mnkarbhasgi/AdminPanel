            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Industry Page</h1>
                ...
                <div class="col-lg-12 pt-5">
                    ...
                    <form action="{{url('/admin/industryupdate')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="featured_content" class="form-control" id="exampleInput2" aria-describedby="emailHelp" placeholder="Enter Content" value="{{ $testi['featured_content'] }}">
                        </div>
                                                
                        <div class="form-group">
                            <label for="inputGroupFile01">Old Featured Image</label>
                            <br>
                            @php $file_name = $testi['featured_image_path']; @endphp
                        ...
                        <div class="input-group">
                            <input type="file" name="featured_img" class="form-control" id="inputGroupFile01">
                        </div>
                        <small id="emailHelp" class="form-text text-muted mb-3">Image size : 48 X 48 px</small>
                        
                        {{-- <div class="form-group">
                            <label for="inputGroupFile01">Old Banner Image</label>
                            <br>
                            @php $file_name = $testi['banner_image_path']; @endphp
                            <img class="img" src="{{asset("$file_name")}}" style="min-width: 400px; min-height: 200px; max-width: 1200px;" />
                        </div>
                        <div class="form-group">
