                    ...
                    <form action="{{url('/admin/update_career')}}" method="post" enctype="multipart/form-data" >
                        ...
                        <div id="dynamic_field">
                            <div class="form-group">
                                ...
                                <td><button type="button" name="remove" id="{{$i}}" class="btn btn-default btn_remove">Delete Text Field</button></td>
                                </div>
                                @php $i++; @endphp
                                @endforeach
                        ...
                        <div id="dynamic_field2">
                                ...
                                <td><button type="button" name="remove" id="{{$j}}" class="btn btn-default btn_remove2">Delete Text Field</button></td>
                                </div>
                                @php $j++; @endphp
                                @endforeach
...
@section('footer-js')
    ...
    // var gArrayFonts = ['Amethysta','Poppins','Poppins-Bold','Poppins-Black','Poppins-Extrabold','Poppins-Extralight','Poppins-Light','Poppins-Medium','Poppins-Semibold','Poppins-Thin'];
        $(document).ready(function() {
            ...
            $('#add').click(function(){  
                i++;  
                $('#dynamic_field').append('<div  id="1row'+i+'" class="form-group dynamic-added"><td><input type="text" name="roles2[]" class="form-control" id="roles" aria-describedby="roles" placeholder="Enter Roles"></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-default btn_remove">Remove Text Field</button></td></div>');  
            });
            ...
            $('#add2').click(function(){  
                i++;  
                $('#dynamic_field2').append('<div  id="row'+i+'" class="form-group dynamic-added"><td><input type="text" name="skills2[]" class="form-control" id="skills" aria-describedby="Skills" placeholder="Enter Skills"></td><td><button type="button" name="remove2" id="'+i+'" class="btn btn-default btn_remove2">Remove Text Field</button></td></div>');  
            });
