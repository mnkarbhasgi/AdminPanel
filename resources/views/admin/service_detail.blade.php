...
{{-- <link href="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" rel="stylesheet"> --}}
            <!-- Begin Page Content -->
                ...
                <div class="col-lg-12 pt-5">
                    ...
                    <form action="{{url('/admin/update_service')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <img class="img" src="{{ asset('storage/featured_image/'.$file_name) }}" style="min-width: 400px; min-height: 200px; max-width: 1200px;" />
                        </div>
                        <div class="form-group">
