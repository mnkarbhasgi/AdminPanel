...
{{-- <link href="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" rel="stylesheet"> --}}
            <!-- Begin Page Content -->
                ...
                <div class="col-lg-12 pt-5">
                    <form action="service_store" method="post" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="featured_content" id="exampleFormControlTextarea1" rows="3">Featured Content</textarea>
                        </div>
                        <div class="form-group">
                          <label for="inputGroupFile01">Upload featured Image</label>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="inputGroupFile01">Main Content</label>
                          </div>
                        <div class="form-group">
