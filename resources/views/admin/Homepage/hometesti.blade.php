...
{{-- <link href="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" rel="stylesheet"> --}}
            <!-- Begin Page Content -->
                ...
                <div class="col-lg-12 pt-5">
                    ...
                    <form action="{{url('/admin/updatehometesti')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label for="exampleInput2">Designation</label>
                            <input type="text" name="designation" class="form-control" id="exampleInput2" aria-describedby="emailHelp" placeholder="Enter Designation" value="{{ $testi['designation'] }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInput2">Company Name</label>
                            <input type="text" name="company" class="form-control" id="exampleInput2" aria-describedby="emailHelp" placeholder="Enter Company Name" value="{{ $testi['company'] }}">
                        </div>
